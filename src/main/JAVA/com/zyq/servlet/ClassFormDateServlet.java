...
@WebServlet(name = "ClassFormDateServlet",value = "/pages/ClassFormDateServlet")
public class ClassFormDateServlet extends HttpServlet {
    //业务层
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        //获取信息保存集合
        List<ClassName> ClassDateFromList = classService.getClassList(ClassName, ClassStatus, page);
        //传入集合
        request.getSession().setAttribute("ClassDateFromList", ClassDateFromList);
        //传入count数据
        ...
        //请求转发
        request.getRequestDispatcher("ClassFormDate.jsp").forward(request, response);
    }
